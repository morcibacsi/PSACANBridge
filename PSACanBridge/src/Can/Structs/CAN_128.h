...
union Can2004CombineLightsByte2 {
    struct {
        ...
        uint8_t activate_front_passenger_protection : 1; // bit 2
...
union Can2004CombineLightsByte3 {
    struct {
        ...
        uint8_t change_personalization : 1; // bit 6
        uint8_t change_color           : 1; // bit 7
    } data;
    uint8_t asByte;
};

union Can2004CombineLightsByte4 {
    struct {
        uint8_t rear_seatbelt_warning_blinking      : 1; // bit 0
        ...
        uint8_t passenger_seatbelt_warning_blinking : 1; // bit 6
        uint8_t driver_seatbelt_warning_blinking    : 1; // bit 7
    } data;
    uint8_t asByte;
};
...
union Can2004CombineLightsByte6 {
    struct {
        ...
        uint8_t row1_rr_seatbelt_forgotten_blinking : 1; // bit 1
        uint8_t row1_rr_seatbelt_forgotten          : 1; // bit 2
        uint8_t row1_rc_seatbelt_forgotten_blinking : 1; // bit 3
        uint8_t row1_rc_seatbelt_forgotten          : 1; // bit 4
        uint8_t row1_rl_seatbelt_forgotten_blinking : 1; // bit 5
        uint8_t row1_rl_seatbelt_forgotten          : 1; // bit 6
...
union Can2004CombineLightsByte7 {
    struct {
        ...
        uint8_t gear_position_drive  : 3; // bit 1-3
        uint8_t gear_position_cmb    : 4; // bit 4-7
    } data;
    uint8_t asByte;
};
